...
jobs:
    build-scan:
        uses: Home-Office-Digital/core-cloud-workflow-docker-actions/.github/workflows/build-scan.yml@1.1.0
        with:
            working_directory: "."
    ...
    build-scan-push:
        uses: Home-Office-Digital/core-cloud-workflow-docker-actions/.github/workflows/build-scan-push.yml@1.1.0
        with:
            working_directory: "."
            dockerfile: "Dockerfile"
            image_name: "hello-world"
